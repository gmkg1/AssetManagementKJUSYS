...
public class AssetsSearchHandler implements Handler<RoutingContext> {
  private final AssetsService assetsService;
  
  public AssetsSearchHandler(AssetsService assetsService) {
  ...
  public void handle(RoutingContext routingContext) {
    ...
    try {
      ...
      JsonArray result = assetsService.searchAssets(query);
