...
public class GetCategoryCountHandler implements Handler<RoutingContext> {

  private static final Logger LOGGER =
    LoggerFactory.getLogger(GetCategoryCountHandler.class);

  private final AssetsService assetsService;

  public GetCategoryCountHandler(AssetsService assetsService) {
